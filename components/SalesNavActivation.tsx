          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-8 lg:p-16 flex flex-col justify-center">
              ...
              <p className="text-blue-100 text-lg mb-8">
                Don't pay $100+/month to LinkedIn. For just <span className="text-white font-bold">$99</span>, we activate a Sales Navigator Advanced account for you for one month. Run unlimited searches and gather your URLs effortlessly.
              </p>
